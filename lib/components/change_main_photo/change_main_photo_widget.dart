                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    valueOrDefault<String>(
                      _model.uploadedFileUrl_uploadDataInx,
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(
                          () => _model.isDataUploading_uploadDataInx = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadDataInx = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadDataInx =
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await widget.propertyRef!.reference
                      ...
                      mainImage: _model.uploadedFileUrl_uploadDataInx,
                    ));
                  },
                  text: 'Save Photo',
                  options: FFButtonOptions(

                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    valueOrDefault<String>(
                      _model.uploadedFileUrl_uploadDataZ1w,
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(
                          () => _model.isDataUploading_uploadDataZ1w = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadDataZ1w = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadDataZ1w =
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await currentUserReference!.update(createUsersRecordData(
                      photoUrl: _model.uploadedFileUrl_uploadDataZ1w,
                    ));
                  },
                  text: 'Save Photo',
                  options: FFButtonOptions(

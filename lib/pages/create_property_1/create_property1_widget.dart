...
class CreateProperty1Widget extends StatefulWidget {
  ...
  static String routeName = 'createProperty_1';
  static String routePath = '/createProperty1';
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataHwj = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataHwj = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataHwj =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataHwj =
                                  downloadUrls.first;
                            });
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              await propertiesRecordReference
                                ...
                                mainImage: _model.uploadedFileUrl_uploadDataHwj,
                                propertyAddress:
                              ...
                              context.pushNamed(
                                CreateProperty2Widget.routeName,
                                queryParameters: {

...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: HomePageMAINWidget.routeName,
          path: HomePageMAINWidget.routePath,
        ...
        FFRoute(
          name: SearchPropertiesWidget.routeName,
          path: SearchPropertiesWidget.routePath,
        ...
        FFRoute(
          name: PropertyReviewWidget.routeName,
          path: PropertyReviewWidget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: BookNowWidget.routeName,
          path: BookNowWidget.routePath,
          asyncParams: {
            'propertyDetails':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: CreateProperty1Widget.routeName,
          path: CreateProperty1Widget.routePath,
        ...
        FFRoute(
          name: CreateProperty2Widget.routeName,
          path: CreateProperty2Widget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
            'propertyAmenities':
        ...
        FFRoute(
          name: CreateProperty3Widget.routeName,
          path: CreateProperty3Widget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: MyPropertiesWidget.routeName,
          path: MyPropertiesWidget.routePath,
          builder: (context, params) => MyPropertiesWidget(),
        ),
        FFRoute(
          name: PropertyDetailsOwnerWidget.routeName,
          path: PropertyDetailsOwnerWidget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: TripDetailsHOSTWidget.routeName,
          path: TripDetailsHOSTWidget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
            'tripRef': getDoc(['trips'], TripsRecord.fromSnapshot),
        ...
        FFRoute(
          name: EditProperty1Widget.routeName,
          path: EditProperty1Widget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: EditProperty2Widget.routeName,
          path: EditProperty2Widget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
            'propertyAmenities':
        ...
        FFRoute(
          name: EditProperty3Widget.routeName,
          path: EditProperty3Widget.routePath,
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
